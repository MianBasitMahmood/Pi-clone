...
import com.google.android.gms.internal.br.C1034a;
...
public interface bd extends IInterface {
    ...
    public static abstract class C1026a extends Binder implements bd {

        /* renamed from: com.google.android.gms.internal.bd.a.a */
        private static class C1025a implements bd {
            private IBinder le;
            ...
            public void m4215a(ay ayVar) throws RemoteException {
            ...
            public void m4216a(bc bcVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
            ...
            public void m4217a(bf bfVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
            ...
            public void m4218a(br brVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
            ...
            public void m4219a(en enVar) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
            ...
            public void m4220a(er erVar, String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
            ...
            public boolean m4221a(av avVar) throws RemoteException {
                boolean z = true;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
            ...
            public C0752d ab() throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IAdManager");
            ...
            public ay ac() throws RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    ay c = obtain2.readInt() != 0 ? ay.CREATOR.m4203c(obtain2) : null;
                    obtain2.recycle();
                    obtain.recycle();
                    return c;
                } catch (Throwable th) {
        ...
        public static bd m4222f(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdManager");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof bd)) ? new C1025a(iBinder) : (bd) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case Error.AVS_DECLINE /*7*/:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IAdManager");
                    m4209a(C1021a.m4190e(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case Error.FRAUD_DECLINE /*8*/:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IAdManager");
                    m4210a(C1023a.m4205h(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                ...
                case CommonStatusCodes.ERROR /*13*/:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IAdManager");
                    if (parcel.readInt() != 0) {
                        ayVar = ay.CREATOR.m4203c(parcel);
                    }
                    m4208a(ayVar);
                    parcel2.writeNoException();
                    return true;
                case GamesStatusCodes.STATUS_INTERRUPTED /*14*/:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IAdManager");
                    m4212a(C1110a.m4524v(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case GamesStatusCodes.STATUS_TIMEOUT /*15*/:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IAdManager");
                    m4213a(C1116a.m4530z(parcel.readStrongBinder()), parcel.readString());
                    parcel2.writeNoException();
                    return true;
                case 18:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IAdManager");
                ...
                case TimeUtils.HUNDRED_DAY_FIELD_LEN /*19*/:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IAdManager");
                    m4211a(C1034a.m4267j(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
    ...
    void m4208a(ay ayVar) throws RemoteException;

    void m4209a(bc bcVar) throws RemoteException;

    void m4210a(bf bfVar) throws RemoteException;

    void m4211a(br brVar) throws RemoteException;

    void m4212a(en enVar) throws RemoteException;

    void m4213a(er erVar, String str) throws RemoteException;

    boolean m4214a(av avVar) throws RemoteException;

    C0752d ab() throws RemoteException;
