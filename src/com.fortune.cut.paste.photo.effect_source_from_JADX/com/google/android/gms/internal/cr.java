...
public final class cr {
    ...
    public cr(String str) throws JSONException {
        ...
        if (gr.m4778v(2)) {
            gr.m4772V("Mediation Response JSON: " + jSONObject.toString(2));
        }
        ...
        if (optJSONObject != null) {
            ...
            this.qw = cw.m4380a(optJSONObject, "click_urls");
            this.qx = cw.m4380a(optJSONObject, "imp_urls");
            this.qy = cw.m4380a(optJSONObject, "nofill_urls");
    ...
    private boolean m4364a(cq cqVar) {
