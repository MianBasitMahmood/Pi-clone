...
public interface bc extends IInterface {
    ...
    public static abstract class C1021a extends Binder implements bc {

        /* renamed from: com.google.android.gms.internal.bc.a.a */
        private static class C1024a implements bc {
            private IBinder le;
        ...
        public static bc m4190e(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof bc)) ? new C1024a(iBinder) : (bc) queryLocalInterface;
        }
