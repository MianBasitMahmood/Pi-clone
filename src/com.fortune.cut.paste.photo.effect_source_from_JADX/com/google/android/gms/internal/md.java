...
public interface md extends IInterface {
    ...
    public static abstract class C1296a extends Binder implements md {

        /* renamed from: com.google.android.gms.internal.md.a.a */
        private static class C1313a implements md {
            private IBinder le;
            ...
            public void m5414j(Status status) throws RemoteException {
        ...
        public static md az(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof md)) ? new C1313a(iBinder) : (md) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case DataEvent.TYPE_CHANGED /*1*/:
                    ...
                    m5348j(parcel.readInt() != 0 ? Status.CREATOR.createFromParcel(parcel) : null);
    ...
    void m5348j(Status status) throws RemoteException;
}
