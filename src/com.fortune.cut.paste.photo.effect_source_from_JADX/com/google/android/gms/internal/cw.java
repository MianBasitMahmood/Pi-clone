...
public final class cw {
    public static List<String> m4380a(JSONObject jSONObject, String str) throws JSONException {
    ...
    public static void m4381a(Context context, String str, fy fyVar, String str2, boolean z, List<String> list) {
        String str3 = z ? "1" : "0";
