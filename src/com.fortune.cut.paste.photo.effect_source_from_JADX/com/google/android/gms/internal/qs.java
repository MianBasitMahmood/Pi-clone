...
class qs {
    ...
    private boolean m5995a(int[] iArr, int[] iArr2, int i) {
    ...
    private boolean m5996a(qt[] qtVarArr, qt[] qtVarArr2, int i) {
        for (int i2 = 0; i2 < i; i2++) {
    ...
    public void m5997a(int i, qt qtVar) {
        int hj = hj(i);
        if (hj >= 0) {
            this.azc[hj] = qtVar;
            return;
    ...
    public boolean equals(Object obj) {
        ...
        qs qsVar = (qs) obj;
        return size() != qsVar.size() ? false : m5995a(this.azb, qsVar.azb, this.mSize) && m5996a(this.azc, qsVar.azc, this.mSize);
    }
