...
public interface em extends IInterface {
    ...
    public static abstract class C1104a extends Binder implements em {

        /* renamed from: com.google.android.gms.internal.em.a.a */
        private static class C1108a implements em {
            private IBinder le;
        ...
        public static em m4499u(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof em)) ? new C1108a(iBinder) : (em) queryLocalInterface;
        }
