...
public class nn implements SafeParcelable, Geofence {
    public static final no CREATOR;
    ...
    private static void m5675a(double d, double d2) {
        if (d > 90.0d || d < -90.0d) {
    ...
    private static void m5676b(float f) {
        if (f <= 0.0f) {
    ...
    public static nn m5677h(byte[] bArr) {
    ...
    public String toString() {
        return String.format(Locale.US, "Geofence[%s id:%s transitions:%d %.6f, %.6f %.0fm, resp=%ds, dwell=%dms, @%d]", new Object[]{eI(this.agf), this.Zt, Integer.valueOf(this.agd), Double.valueOf(this.agg), Double.valueOf(this.agh), Float.valueOf(this.agi), Integer.valueOf(this.agj / LocationStatusCodes.GEOFENCE_NOT_AVAILABLE), Integer.valueOf(this.agk), Long.valueOf(this.ahl)});
    }

    public void writeToParcel(Parcel parcel, int i) {
        no noVar = CREATOR;
        no.m5678a(this, parcel, i);
    }
}
