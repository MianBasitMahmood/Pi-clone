...
public final class fr {
    private static final SimpleDateFormat uD;

    static {
        uD = new SimpleDateFormat("yyyyMMdd");
    }

    public static fj m4635a(Context context, fh fhVar, String str) {
        try {
            fj fjVar;
            List list;
            List list2;
            ...
            if (TextUtils.isEmpty(optString4)) {
                if (TextUtils.isEmpty(optString2)) {
                    gr.m4773W("Could not parse the mediation config: Missing required ad_html or ad_url field.");
                    return new fj(0);
                }
                fj a = fq.m4631a(context, fhVar.lO.wS, optString2, null, null);
                optString = a.sg;
                optString4 = a.tU;
                j = a.ua;
                fjVar = a;
            } else if (TextUtils.isEmpty(optString)) {
                gr.m4773W("Could not parse the mediation config: Missing required ad_base_url field");
                return new fj(0);
            } else {
                fjVar = null;
            }
            ...
            gr.m4773W("Could not parse the mediation config: " + e.getMessage());
            return new fj(0);
        }
    }

    public static String m4636a(fh fhVar, fv fvVar, Location location, String str, String str2, String str3) {
        try {
            ...
            m4638a((HashMap) hashMap, fhVar.tL);
            ...
            m4640a((HashMap) hashMap, fvVar);
            if (fhVar.tL.versionCode >= 2 && fhVar.tL.ol != null) {
                m4637a((HashMap) hashMap, fhVar.tL.ol);
            }
            ...
            if (gr.m4778v(2)) {
                gr.m4772V("Ad Request JSON: " + gi.m4743t(hashMap).toString(2));
            }
            return gi.m4743t(hashMap).toString();
        } catch (JSONException e) {
            gr.m4773W("Problem serializing ad request to JSON: " + e.getMessage());
            return null;
        }
    }

    private static void m4637a(HashMap<String, Object> hashMap, Location location) {
    ...
    private static void m4638a(HashMap<String, Object> hashMap, av avVar) {
        String dr = ge.dr();
        if (dr != null) {
            hashMap.put("abf", dr);
        }
        ...
        if (avVar.versionCode >= 2) {
            ...
            if (avVar.ok != null) {
                m4639a((HashMap) hashMap, avVar.ok);
            }
        }
    ...
    private static void m4639a(HashMap<String, Object> hashMap, bj bjVar) {
        Object obj;
        Object obj2 = null;
        if (Color.alpha(bjVar.oQ) != 0) {
            hashMap.put("acolor", m4642u(bjVar.oQ));
        }
        if (Color.alpha(bjVar.backgroundColor) != 0) {
            hashMap.put("bgcolor", m4642u(bjVar.backgroundColor));
        }
        if (!(Color.alpha(bjVar.oR) == 0 || Color.alpha(bjVar.oS) == 0)) {
            hashMap.put("gradientto", m4642u(bjVar.oR));
            hashMap.put("gradientfrom", m4642u(bjVar.oS));
        }
        if (Color.alpha(bjVar.oT) != 0) {
            hashMap.put("bcolor", m4642u(bjVar.oT));
        }
        ...
        if (Color.alpha(bjVar.oY) != 0) {
            hashMap.put("dcolor", m4642u(bjVar.oY));
        }
        if (bjVar.oZ != null) {
            hashMap.put("font", bjVar.oZ);
        }
        if (Color.alpha(bjVar.pa) != 0) {
            hashMap.put("hcolor", m4642u(bjVar.pa));
        }
    ...
    private static void m4640a(HashMap<String, Object> hashMap, fv fvVar) {
        hashMap.put("am", Integer.valueOf(fvVar.vg));
        hashMap.put("cog", m4641u(fvVar.vh));
        hashMap.put("coh", m4641u(fvVar.vi));
        ...
        hashMap.put("ma", m4641u(fvVar.vm));
        hashMap.put("sp", m4641u(fvVar.vn));
    ...
    private static Integer m4641u(boolean z) {
        return Integer.valueOf(z ? 1 : 0);
    }

    private static String m4642u(int i) {
