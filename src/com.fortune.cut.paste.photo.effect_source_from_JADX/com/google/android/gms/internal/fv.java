...
public final class fv {
    ...
    public fv(Context context) {
        ...
        this.vh = m4672a(packageManager, "geo:0,0?q=donuts") != null;
        this.vi = m4672a(packageManager, "http://www.google.com") != null;
        ...
        this.vp = m4673a(packageManager);
        this.vq = audioManager.getStreamVolume(3);
        this.vr = m4671a(context, connectivityManager, packageManager);
    ...
    private static int m4671a(Context context, ConnectivityManager connectivityManager, PackageManager packageManager) {
        if (!gi.m4732a(packageManager, context.getPackageName(), "android.permission.ACCESS_NETWORK_STATE")) {
            return -2;
        }
    ...
    private static ResolveInfo m4672a(PackageManager packageManager, String str) {
    ...
    private static String m4673a(PackageManager packageManager) {
        String str = null;
        ResolveInfo a = m4672a(packageManager, "market://details?id=com.google.android.gms.ads");
        if (a != null) {
