...
public interface IMapFragmentDelegate extends IInterface {
    ...
    public static abstract class C1589a extends Binder implements IMapFragmentDelegate {

        /* renamed from: com.google.android.gms.maps.internal.IMapFragmentDelegate.a.a */
        private static class C1588a implements IMapFragmentDelegate {
            private IBinder le;
            ...
            public void onInflate(C0752d c0752d, GoogleMapOptions googleMapOptions, Bundle bundle) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IMapFragmentDelegate");
        ...
        public static IMapFragmentDelegate aX(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapFragmentDelegate)) ? new C1588a(iBinder) : (IMapFragmentDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case DataEvent.TYPE_DELETED /*2*/:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                    onInflate(C0754a.ap(parcel.readStrongBinder()), parcel.readInt() != 0 ? GoogleMapOptions.CREATOR.cX(parcel) : null, parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
    ...
    void onInflate(C0752d c0752d, GoogleMapOptions googleMapOptions, Bundle bundle) throws RemoteException;
