...
public interface C1522q extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.q.a */
    public static abstract class C1523a extends Binder implements C1522q {

        /* renamed from: com.google.android.gms.maps.internal.q.a.a */
        private static class C1624a implements C1522q {
            private IBinder le;

            C1624a(IBinder iBinder) {
                this.le = iBinder;
            }
            ...
            public void m6169c(Location location) throws RemoteException {
            ...
            public void m6170g(C0752d c0752d) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IOnMyLocationChangeListener");
        ...
        public static C1522q bk(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C1522q)) ? new C1624a(iBinder) : (C1522q) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case DataEvent.TYPE_CHANGED /*1*/:
                    ...
                    m6113g(C0754a.ap(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case DataEvent.TYPE_DELETED /*2*/:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IOnMyLocationChangeListener");
                    m6112c(parcel.readInt() != 0 ? (Location) Location.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
    ...
    void m6112c(Location location) throws RemoteException;

    void m6113g(C0752d c0752d) throws RemoteException;
}
