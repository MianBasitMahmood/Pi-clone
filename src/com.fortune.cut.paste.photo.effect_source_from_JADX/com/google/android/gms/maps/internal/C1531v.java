...
public interface C1531v extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.v.a */
    public static abstract class C1532a extends Binder implements C1531v {

        /* renamed from: com.google.android.gms.maps.internal.v.a.a */
        private static class C1629a implements C1531v {
            private IBinder le;

            C1629a(IBinder iBinder) {
                this.le = iBinder;
            }
            ...
            public void m6172h(C0752d c0752d) throws RemoteException {
        ...
        public static C1531v bq(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ISnapshotReadyCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C1531v)) ? new C1629a(iBinder) : (C1531v) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case DataEvent.TYPE_DELETED /*2*/:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.ISnapshotReadyCallback");
                    m6116h(C0754a.ap(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
    ...
    void m6116h(C0752d c0752d) throws RemoteException;
