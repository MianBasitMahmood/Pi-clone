...
public class C0522a implements SafeParcelable {
    public static final Creator<C0522a> CREATOR;
    final int CK;
    final int Gt;
    ...
    C0522a(int i, ParcelFileDescriptor parcelFileDescriptor, int i2) {
        this.CK = i;
    ...
    private void m1872a(Closeable closeable) {
        try {
            closeable.close();
        } catch (Throwable e) {
