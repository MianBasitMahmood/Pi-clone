...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder(Activity activity, PlusClient plusClient) {
            this(activity);
            jx.m5217a(plusClient != null, "PlusClient must not be null.");
            jx.m5217a(plusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
            jx.m5217a(plusClient.os().cj(Scopes.PLUS_LOGIN), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
        ...
        public Builder addCallToAction(String str, Uri uri, String str2) {
            jx.m5217a(this.anE, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            boolean z = (uri == null || TextUtils.isEmpty(uri.toString())) ? false : true;
            jx.m5221b(z, (Object) "Must provide a call to action URL");
            ...
            if (!TextUtils.isEmpty(str2)) {
                jx.m5217a(PlusShare.cg(str2), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent() {
            ...
            jx.m5217a(z3, "Call-to-action buttons are only available for URLs.");
            z3 = !booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL);
            jx.m5217a(z3, "The content URL is required for interactive posts.");
            ...
            jx.m5217a(z, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                jx.m5217a(PlusShare.cg(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), "The specified deep-link ID was malformed.");
            }
            if (!z2 && equals) {
        ...
        public Builder setContentDeepLinkId(String str, String str2, String str3, Uri uri) {
            jx.m5221b(this.anE, (Object) "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            jx.m5221b(!TextUtils.isEmpty(str), (Object) "The deepLinkId parameter is required.");
            Bundle a = PlusShare.m6272a(str2, str3, uri);
    ...
    public static Bundle m6272a(String str, String str2, Uri uri) {
        Bundle bundle = new Bundle();
