...
public interface IGamesSignInCallbacks extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGamesSignInCallbacks {
        ...
        private static class Proxy implements IGamesSignInCallbacks {
            ...
            public void m3628U(DataHolder dataHolder) throws RemoteException {
            ...
            public void m3629V(DataHolder dataHolder) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.games.internal.IGamesSignInCallbacks");
            ...
            public void m3630b(int i, Intent intent) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.games.internal.IGamesSignInCallbacks");
            ...
            public void m3631g(DataHolder dataHolder) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.games.internal.IGamesSignInCallbacks");
    ...
    void m3624U(DataHolder dataHolder) throws RemoteException;

    void m3625V(DataHolder dataHolder) throws RemoteException;

    void m3626b(int i, Intent intent) throws RemoteException;
    ...
    void m3627g(DataHolder dataHolder) throws RemoteException;
}
