...
class aw implements bm {
    ...
    private InputStream m6435a(HttpURLConnection httpURLConnection) throws IOException {
    ...
    private void m6436b(HttpURLConnection httpURLConnection) {
