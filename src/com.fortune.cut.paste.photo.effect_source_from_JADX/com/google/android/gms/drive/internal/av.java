...
public class av implements Creator<OnResourceIdSetResponse> {
    static void m2169a(OnResourceIdSetResponse onResourceIdSetResponse, Parcel parcel, int i) {
        int H = C0542b.m1955H(parcel);
        C0542b.m1980c(parcel, 1, onResourceIdSetResponse.getVersionCode());
        C0542b.m1979b(parcel, 2, onResourceIdSetResponse.iF(), false);
