...
public class FragmentActivity extends Activity {
    ...
    protected void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i3 != 0) {
            ...
            if (fragment == null) {
                ...
                fragment.onActivityResult(GameRequest.TYPE_ALL & i, i2, intent);
                return;
            }
        }
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i) {
        if (i == -1) {
            ...
            super.startActivityForResult(intent, ((fragment.mIndex + MSG_REALLY_STOPPED) << 16) + (GameRequest.TYPE_ALL & i));
        }
    }
