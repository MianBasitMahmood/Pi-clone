...
class SearchViewCompatHoneycomb {
    ...
    static class C00661 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C00661(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C00672 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C00672(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
    ...
    public static Object newOnQueryTextListener(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
        return new C00661(onQueryTextListenerCompatBridge);
    }
    ...
    public static Object newOnCloseListener(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
        return new C00672(onCloseListenerCompatBridge);
    }
