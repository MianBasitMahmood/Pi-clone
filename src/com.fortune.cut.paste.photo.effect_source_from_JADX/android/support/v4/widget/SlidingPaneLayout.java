...
public class SlidingPaneLayout extends ViewGroup {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    if (!this.mCanSlide || this.mParallaxBy == 0) {
                        ...
                        i5 = (int) ((TextTrackStyle.DEFAULT_FONT_SCALE - this.mSlideOffset) * ((float) this.mParallaxBy));
                    }
                    i11 = i5;
                    i10 = paddingRight;
                }
    ...
    private boolean openPane(View view, int i) {
        if (!this.mFirstLayout && !smoothSlideTo(TextTrackStyle.DEFAULT_FONT_SCALE, i)) {
            return false;
        }
            ...
            if ((isLayoutRtlSupport ? layoutParams.rightMargin : layoutParams.leftMargin) <= 0) {
                ...
                for (i = 0; i < childCount; i++) {
                    ...
                    if (childAt != this.mSlideableView) {
                        i2 = (int) ((TextTrackStyle.DEFAULT_FONT_SCALE - this.mParallaxOffset) * ((float) this.mParallaxBy));
                        this.mParallaxOffset = f;
                        i2 -= (int) ((TextTrackStyle.DEFAULT_FONT_SCALE - f) * ((float) this.mParallaxBy));
                        if (isLayoutRtlSupport) {
                            i2 = -i2;
                        }
                        ...
                        if (obj == null) {
                            if (isLayoutRtlSupport) {
                                f2 = TextTrackStyle.DEFAULT_FONT_SCALE - this.mParallaxOffset;
                            } else {
                                f2 = this.mParallaxOffset - TextTrackStyle.DEFAULT_FONT_SCALE;
                            }
