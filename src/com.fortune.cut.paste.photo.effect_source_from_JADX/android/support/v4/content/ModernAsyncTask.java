...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    class C00152 extends WorkerRunnable<Params, Result> {
        C00152() {
            super();
        }
    ...
    class C00163 extends FutureTask<Result> {
        C00163(Callable callable) {
            super(callable);
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C00152();
        this.mFuture = new C00163(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        if (this.mStatus != Status.PENDING) {
            switch (C00174.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
